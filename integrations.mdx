...
<CardGroup cols={2}>
  <Card title="AI Assistants (MCP)" icon="robot" href="/mcp/overview">
    Connect Claude, ChatGPT, Gemini, Cursor, or VS Code to manage your entire platform through conversation. 26 tools across contacts, agents, campaigns, calls, deals, and webhooks.
  </Card>
