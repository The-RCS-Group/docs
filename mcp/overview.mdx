...
The SmartAlex MCP server exposes **26 tools**, **7 resources**, and **5 prompts** — giving AI assistants full operational access to your SmartAlex workspace.
...
SmartAlex exposes 26 tools organized across 7 domains. All tool names are prefixed with `smartalex_` to avoid conflicts with other MCP servers.
...
| Tool | Description |
|------|-------------|
| `smartalex_list_phone_numbers` | List available phone numbers for outbound calling |
...
- [Tools Reference](/mcp/tools-reference) — Complete reference for all 26 tools with parameters and examples
