...
You should see `smartalex` listed with 18 tools.
...
The npm package provides the same 18 tools, 7 resources, and 5 prompts as the cloud endpoint:

| Category | Count | Examples |
|----------|-------|---------|
| **Tools** | 18 | `smartalex_list_contacts`, `smartalex_create_deal`, `smartalex_get_call` |
...
- [Tools Reference](/mcp/tools-reference) — Complete reference for all 18 tools
