...
**Assistant calls:** `smartalex_list_agents`

**Assistant:** "You have 3 agents:

| Agent | Language | Status |
|-------|----------|--------|
| Sales Assistant | English | Active |
| Support Agent | English | Active |
| Spanish Outreach | Spanish | Inactive |

Which agent would you like to assign to the campaign?"

**You:** "Create an outbound campaign called 'Q2 Enterprise Outreach' and assign the Sales Assistant."
...
**Assistant:** "Created 'Q2 Enterprise Outreach' as an outbound campaign with the Sales Assistant agent assigned."
...
- [Tools Reference](/mcp/tools-reference) — Complete parameter reference for all 18 tools
