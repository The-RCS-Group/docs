...
Phone numbers are $1/month flat, regardless of country. Your Professional plan includes 1 phone number at no extra cost. Per-minute usage is billed separately — see the [Pricing page](/pricing).
</Accordion>
...
Anything else can be wired up via the REST API and webhooks. See [Integrations](/integrations).
</Accordion>
...
Check that:
1. Agent is **Active** (not Draft or Error)
